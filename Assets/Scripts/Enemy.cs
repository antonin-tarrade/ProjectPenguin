...
public class Enemy : Penguin
{
    ...
    private void Update()
    {
        ...
        {
            movement = (pathfinder.currentDirection.normalized) * speed;
        }
    ...
    protected override void Fire()
    {
        ...
        float angle = Vector3.Angle(targetDir, facingDirection);
        if (angle > maxShootAngle) attack.Fire(facingDirection);
        else attack.Fire(targetDir);
    }
