...
//syst�me de priorit� (contrainte pond�r�e)
//OU
//de distance critique (distance � partir de laquelle on ne cherche plus � s'approcher de la cible mais seulement � s'�loigner de l'objet)
